...
g_transport_distance_cap = 20;				// Maximum distance between the target and transport in meters
g_transport_forgiveness_multiplier = 1.2;	// Forgiveness multiplier is applied to all calculations for a fudge factor. It is a game after all. 
